...
const categories = [
    ...
    { name: 'Frontend Developer', slug: 'frontend', color: '#FF9800' },
    { name: 'Backend Developer', slug: 'backend', color: '#9C27B0' },
    { name: 'Fullstack Developer', slug: 'fullstack', color: '#E91E63' },
      { name: 'UI/UX Designer', slug: 'uiux', color: '#2196F3' },
